...
const Footer = () => {
	return (
		<>
			<section className=" bg-gray-50	font-DMsans mt-20 w-full md:invisible md:absolute md:bottom-0">
				...
				<div className="grid grid-rows-3 grid-flow-col gap-24 ml-28 mt-8 w-4/5 mb-8 text-xs	text-gray-500">
					<ul className="row-start-1 row-end-4	">
						...
						<li className="mb-2	">
							<a href="">Airports and terminals</a>
						</li>
						<li className="mb-2	">
							<a href="">Baggage</a>
						</li>
						<li className="mb-2">
							<a href="">Check-in information</a>
						</li>
						<li className="mb-2">
							<a href="">Our fares</a>
						</li>
						...
						<li className="mb-2">
							<a href="">Seat options</a>
						</li>
						<li className="mb-2">
							<a href="">Tax invoice</a>
						</li>
						<li className="mb-2">
							<a href="">AirAsia India tariff sheet</a>
						</li>
					...
					<ul className="row-start-1  row-end-4 ">
						...
						<li className="mb-2">
							<a href="">AirAsia Unlimited Deals</a>
						</li>
						<li className="mb-2">
							<a href="">IKHLAS</a>
						</li>
						...
						<li className="mb-2">
							<a href="">Freedom Flyer Programme</a>
						</li>
						<li className="mb-2">
							<a href="">BIG Points</a>
						</li>
						<li className="mb-2">
							<a href="">BIG Xchange</a>
						</li>
						<li className="mb-2">
							<a href="">Register as an agent</a>
						</li>
						<li className="mb-2">
					...
					<ul className="row-start-1  row-end-4 ">
						<li className="mb-2">
							<a href="">Partners' Product</a>
						</li>
						<li className="mb-2">
							<a href="">Delivery Partner Sign-Up</a>
						</li>
						<li className="mb-2">
							<a href="">airasia Card</a>
						</li>
						<li className="mb-2">
							<a href="">Luggage delivery</a>
						</li>
						<li className="mb-2">
							<a href="">BigPay</a>
						</li>
						<li className="mb-2">
							<a href="">CIMB Savers</a>
						</li>
						<li className="mb-2">
							<a href="">AirAsia Travel Protection</a>
						</li>
						<li>
							<a href="">Santan ASEAN Restaurant</a>
						</li>
					</ul>
					<ul className="row-start-1   row-end-4">
						<li className="mb-2">
				...
				<hr className="ml-28  w-5/6" />
				<div className="grid grid-cols-6 gap-4 ml-28 mt-8 w-5/6 mb-8">
					<div className="col-start-1 col-end-3  col-span-2 float-left">
				...
				<hr />
				<div className="ml-28 mt-8 w-5/6 mb-4 text-xs	 text-gray-500">
					<p>
				...
				<div className="ml-28  mb-8 text-xs">
					<ul className="flex">
