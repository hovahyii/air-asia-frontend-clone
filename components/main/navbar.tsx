...
const NavBar = () => {
	...
	return (
		<nav className="font-DMsans text-center content-center px-16 bg-white lg:border lg:px-2 lg:relative lg:w-screen lg:h-14 lg:shadow-xl	lg:grid lg:justify-items-stretch">
			...
			<div className="flex items-center flex-shrink-0 float-left lg:float-none	  lg:absolute lg:justify-self-center lg:pt-0 ">
				<Image
			...
			<div className="invisible lg:float-right lg:visible lg:absolute lg:justify-self-end ">
				<div className=" lg:pt-4 lg:pb-2 ">
					<a
						href="#"
