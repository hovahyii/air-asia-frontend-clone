...
function Travel() {
	return (
		<>
			<h1 className="font-DMsans text-2xl	text-gray-800   mt-10 ml-44 xl:w-11/12 xl:ml-14 ">
				Travel &amp; Promotions
			</h1>
			<div className="font-DMsans w-4/5 ml-44 mt-4 flex xl:w-11/12 xl:ml-14 md:pb-28">
				{Travels.map((travel) => (
